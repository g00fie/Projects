 ...
 */
class srcApp_Kernel.envDebugContainer extends Container
{
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDirs[0].'/srcApp_Kernel.envDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.container_class' => 'srcApp_Kernel.envDebugContainer',
            'container.dumper.inline_class_loader' => true,
            'env(DATABASE_URL)' => 'mysql://db_user:db_password@localhost:3306/db_name',
            'locale' => 'en',
            ...
            'router.cache_class_prefix' => 'srcApp_Kernel.envDebugContainer',
